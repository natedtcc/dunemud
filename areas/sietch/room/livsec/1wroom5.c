...
Right next to you is a wall with a few tiny\n\
windows. A narrow shelf occupies the wall.\n\
It holds a row of portraits - mostly bared\n\
...
something.\n";
    ...
    dest_dir = (["east":ROOM_DIR + LIVSEC + "2wroom5.c",
                "south":ROOM_DIR + LIVSEC + "swroom1.c",
                "north":ROOM_DIR + LIVSEC + "1wroom4.c",
    ]);
  }
